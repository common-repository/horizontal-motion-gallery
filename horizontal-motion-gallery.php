...
function my_hmg_init()
{
	...
	{
		wp_register_sidebar_widget( 'horizontal-motion-gallery', __('Motion Gallery', 'horizontal-motion-gallery'), 'my_hmg_widget');
	}
	
	if(function_exists('wp_register_widget_control')) 
	{
		wp_register_widget_control( 'horizontal-motion-gallery', array( __('Motion Gallery', 'horizontal-motion-gallery'), 'widgets'), 'my_hmg_control');
	} 
}
